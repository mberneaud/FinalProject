...
In order to cleanly estimate the effect of board membership on re-election probability, it is important to get a good grasp on the determinants of appointment to board positions. We therefore control for obvious potential drivers such as mayors' vote share in the previous election, which serves as a measure of the incumbency advantage. Further control are candidates' sex and municipality size (measured by number of eligible voters) as larger municipalities might offer more resources to retain the mayor's office.
