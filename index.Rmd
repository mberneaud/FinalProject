...
p
```
When we include the vote share a candidate received in the previous election along with board membership and whether or not a mayor was reelected (in the graph above), a much more fuzzy picture emerges. Most mayors who have done really good (>70% of votes) in the last election are reelected. On the other hand, most mayors who do not become reelected gained in between 50% and 70% of the votes in the last election. 

However, it no clear patterns of board-member-mayors cluttering around the high numbers of approval in the previous election. Instead, mayors who are also board members seem scattered randomly throughout reelected and non-reelected mayors. 
